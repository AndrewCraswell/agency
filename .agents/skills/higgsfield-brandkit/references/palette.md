...
Do not select the palette for the user. When the user selects it, immediately save that exact palette through the
Brandkit state script's `approve_palette` action. Do not wait for logo, typography, or a combined review.
