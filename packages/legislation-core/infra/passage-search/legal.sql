...
CREATE TABLE legislation.legal_search_scope_projections (
  scope_kind text NOT NULL CHECK(scope_kind IN ('edition','publication')),
  scope_id uuid NOT NULL,
...
CREATE INDEX legal_search_scope_projection_common_idx ON legislation.legal_search_scope_projections
