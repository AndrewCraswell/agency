...
@media only screen and (max-width: 620px) {
  ...
  /* A half aligned to the right edge reads as stray once it is its own full-width row. */
  .stack-left { text-align: left !important; }
...
@media only screen and (max-width: 480px) {
  ...
  /* A half aligned to the right edge reads as stray once it is its own full-width row. */
  .pair-left { text-align: left !important; }
}
