...
| `U_USB_DATA_PROTECT` | TI `TPD2EUSB30DRTR` | Separate low-capacitance shunt protection from connector-side D+ and D- to ground. TI pin 1 is D1+/D+, pin 2 is D1-/D-, and pin 3 is GND. USB2 data continues through this shunt-protected pair to the ESP32-S3 service path; it does not pass through `TPD4S201TRGRRQ1`. |
