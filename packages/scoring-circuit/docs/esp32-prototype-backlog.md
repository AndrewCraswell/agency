...
| `BP-120` | in-progress | Commit `d07f096` selects `ESP32-S3-WROOM-1-N16R2` and reconciles the canonical contract/BOM to its 16 MB Quad-SPI flash, 2 MB Quad-SPI PSRAM, integrated antenna, 18 x 25.5 x 3.1 mm body, and RF clearance. Root primary-source review, 33 focused tests, package types, lint, and format pass. Pad ownership, bypass, reset/watchdog, and recovery reconciliation remain. | Freeze ESP32 module, pins, support, reset, and recovery. | `BP-020` | Exact module, RF keepout, every pad owner, bypass, EN/BOOT, watchdog/reset, native USB, UART recovery, and unused-pad policy agree. |
