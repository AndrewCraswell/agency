...
| `P0-08` | active | Route and review the PCB. | `P0-07` | Commit `62acaf7` establishes deterministic fail-closed routing, fixes direct-landing port identity and the ESP32 exposed-pad/via model, and explicitly relays out the USB/power and Ethernet/HUB75 islands. Root verification passes 22 focused tests, package types, lint, and format. The current strict build routes 454 of 708 source traces and stops on 259 routing/DRC errors: 154 route failures, 45 disconnected ports, 51 missing traces, four pad-to-trace clearances, and five via clearances. Analog-island placement, four-layer planes/rules, critical-signal constraints, and final DRC clearance remain active. |
