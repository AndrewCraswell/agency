...
| Order and assemble the board | active | Commit `27d23bd` leaves the simplified 39-component board ready for order preparation with Ethernet, encrypted IR, 64x32 HUB75 data and power, USB-C PD power, sound, two FA-05 DATA-LINE outputs, and the seven OpenPiste-style conductors. All 135 electrical connections are routed with zero unresolved connections and zero routing/DRC errors, and all 39 placed components have rendered CAD bodies. Remaining work is procurement, assembly, and electrical bring-up. |
