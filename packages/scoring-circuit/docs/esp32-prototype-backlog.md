...
| `P0-06` | active | Reconcile BOM and footprints and clear schematic errors. | `P0-05` | Commits `818df85`, `02803b1`, and `012b409` approve the WROOM-1, non-BOM weapon/piste landings, and complete acquisition footprint set. Commit `a4eeec8` root-approves the canonical W5500, MagJack, crystal, HUB75 buffer/header, and enable-FET placement footprints from retained official evidence and removes the repeated-render timeout defect. USB/power, ESP32 support, output/display/IR, physical-BOM, and integrated-inventory slices remain under implementation or root review. The old 256 source-component count is not an acceptance target. |
