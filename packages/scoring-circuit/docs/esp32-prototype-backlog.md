...
| Minimal carrier schematic | active | Simplified carrier definition | Commits `214548c` and `c94df08` remove the external ESP32 supervisor/watchdog and replace the discrete W5500/PHY/RJ45 block with one WIZ850io socketed module. The reduced power-module interface is under root revision; the scoring front end, HUB75, IR, outputs, USB recovery, and weapon landings remain. |
