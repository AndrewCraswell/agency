...
| Add sound | active | USB-C power and red/green indicators are complete. Next, finish the existing single transistor-driven sounder path without adding an audio subsystem. |
