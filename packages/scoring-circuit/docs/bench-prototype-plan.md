...
| `BP-033` | in-progress | All dependencies are complete at their pre-order design boundaries. Root-reviewed commit `0dc93a6` adds the exact `TPS25730ADREFR`/`TPS25730AD` REF0038A review candidate for `U_USB_PD`. Root visually verified retained TI pages 1, 4 through 6, and 61 through 63 and accepts the orderable/device/package binding, 38-pin top-view order, published copper, exposed pads 39 GND/40 DRAIN, reference mapping, rendered hash, and deny-state integrity. Project mask, symmetric paste approximation, courtyard, board fit, DRC, native CAD, release, and fabrication remain unapproved. Three focused/dependent suites/17 tests, package types, lint, format, hooks, and diff checks pass. Earlier root-reviewed commits `59ea3bc` and `75e9d28` cover the Samtec HUB75 overlay and W5500 review candidate; BP-146 supplies the root-approved encrypted-IR pre-order geometry and optical-test contract. The corrected Amphenol USB-C receptacle candidate is delivered and next in root review. Remaining lane-D work is exact package, footprint, artwork, orientation, and canonical-reference closure across the other power, Ethernet, application, HUB75, and IR support rows. Panel receipt and powered behavior are owned by BP-502/BP-507. | Close power, Ethernet, application, HUB75, display, and encrypted-IR receiver footprints. | `BP-030`, `BP-050`, `BP-141`, `BP-142`, `BP-143`, `BP-144`, `BP-145`, `BP-146` | Independent evidence record for every populated lane-D reference, including the BP-146 receiver path; audio remains explicit DNP with no host or I2C stub. |
