...
| `BP-031` | blocked | Root-reviewed commits `74d10b4` and `c4efd08` add review-only candidates for the seven exact TDK `CGA3E3X7R1H105K080AB` reference capacitors and `ADA4177-1ARZ` R-8 amplifier. The ADA review visually confirms ADI drawings `012407-A` and `90-0096` Rev. M, corrects body length/width, overall lead span, package height, and lead dimensions, preserves the family-only S8-to-R-8 reconciliation, and derives the 5.50 mm by 7.41 mm courtyard from actual rendered pads versus the maximum package envelope. Root verification passed 32 focused/dependent ADA tests plus the prior 33 TDK tests, package types, lint, format, retained-source hashes, rendered geometry, and diff checks. Both candidates remain CAD-unacquired, orientation-pending, `accepted: false`, and fabrication-denied. BP-031 remains blocked by incomplete dependency `BP-104`; remaining populated-footprint evidence, orientation, schematic reconciliation, and fabrication gates stay open. | Close analog, protection, reference, and weapon-fixture footprints. | `BP-030`, `BP-103`, `BP-104` | Independent evidence record for every populated lane-B reference; unresolved options remain explicit DNP. |
