...
| `BP-033` | in-progress | All dependencies are complete at their pre-order design boundaries. Root-reviewed commits `1d78b14` and `37565e0` retain and link exact Yageo `RC0603FR-07100KL` evidence for `R_W5500_INT_BIAS` and both display-buffer gate pull-downs without importing the self-validating candidate into the canonical ledger. Current lane state is 74 reviewed-unapproved and 27 not-started references. Earlier root-reviewed mappings cover USB-C/PD/protection, branch fuses, TVS and source selection, both eFuse roles, eight W5500 bypass capacitors, four measurement links, 26 Yageo 10 kOhm rows, W5500, encrypted IR, HUB75, six shared KEMET 100 nF rows, three Keystone test points, five TDK 22 uF rows, two BSS138 display-enable MOSFETs, and both display buffers. The remaining families are partitioned into non-overlapping display-limiter, application-regulator, W5500-support, reset, IR, F-RAM, and connector slices. Manufacturer land-pattern/CAD authority, placement, schematic integration, release, and fabrication remain denied. Canonical verification passes 3 files/43 tests with package types, lint, format, and hooks clean. | Close power, Ethernet, application, HUB75, display, and encrypted-IR receiver footprints. | `BP-030`, `BP-050`, `BP-141`, `BP-142`, `BP-143`, `BP-144`, `BP-145`, `BP-146` | Independent evidence record for every populated lane-D reference, including the BP-146 receiver path; audio remains explicit DNP with no host or I2C stub. |
