...
| `BP-031` | blocked | Root-reviewed commits `0679719`, `ae0a7b9`, `8e6d06e`, and `7b783e5` add exact review-only evidence for the seven KEMET bypass capacitors, four selected Vishay CRCW resistor families, seven Murata reference reservoirs, and the exact Molex `43045-1200` weapon-fixture header. The Molex slice binds the exact drawing/CAD preview, 12 circuit holes, two retention holes, circuit-one datum, `43025-1200` mate, and 10.16 mm board-edge rule while keeping copper/mask/courtyard/placement and physical authority denied. Integrated verification passes 35 shared-capacitor, 54 Vishay/dependent, 43 Murata/dependent, and 38 fixture/dependent tests. Earlier reviewed commits cover the other populated analog/reference families. Every candidate remains `accepted: false` and fabrication-denied. BP-031 remains blocked only by incomplete dependency `BP-104`; physical connector fit/orientation, remaining populated-footprint evidence, schematic reconciliation, DC-bias/placement review, and fabrication gates stay open. | Close analog, protection, reference, and weapon-fixture footprints. | `BP-030`, `BP-103`, `BP-104` | Independent evidence record for every populated lane-B reference; unresolved options remain explicit DNP. |
