...
| `BP-143` | blocked | Exact HUB75 connector and panel-power mating selections retained; blocked on purchased-panel receipt, de-energized continuity, mating/orientation, current, cable-drop, and temperature evidence. | Freeze HUB75 connector and panel power mating parts. | `BP-020` | Exact 16-pin signal and power connector MPNs, cable pinout, current rating, and purchased-panel continuity record. |
