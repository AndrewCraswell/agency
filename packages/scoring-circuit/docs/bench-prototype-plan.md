...
| `BP-031` | blocked | Root-reviewed commits `0679719`, `ae0a7b9`, `8e6d06e`, `7b783e5`, `7d2e425`, and `627730a` add exact review-only evidence for the KEMET bypass capacitors, selected Vishay CRCW resistor families, Murata reference reservoirs, Molex weapon-fixture header, TI `TPS60400DBVR` negative-rail device, and TI `TPS7A2033PDBVR` 3.3 V regulator. Both TI DBV0005A slices bind their exact active orderables, five-pin maps, manufacturer copper/mask/stencil guidance, project-only courtyards, orientation data, and rendered artwork while keeping CAD, acceptance, and fabrication authority denied. Integrated verification passes 35 shared-capacitor, 54 Vishay/dependent, 43 Murata/dependent, 38 fixture/dependent, 56 TPS60400/dependent, and 42 TPS7A20/dependent tests. Earlier reviewed commits cover the other populated analog/reference families. BP-031 remains blocked only by incomplete dependency `BP-104`; physical connector evidence, remaining footprint/orientation review, schematic reconciliation, DC-bias/placement review, and fabrication gates stay open. | Close analog, protection, reference, and weapon-fixture footprints. | `BP-030`, `BP-103`, `BP-104` | Independent evidence record for every populated lane-B reference; unresolved options remain explicit DNP. |
