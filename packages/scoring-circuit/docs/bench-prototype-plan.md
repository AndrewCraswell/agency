...
| `BP-033` | in-progress | All dependencies are complete at their pre-order design boundaries. Root-reviewed commits `ee4c195` and `89d8fbd` link the exact WIZnet `W5500` LQFP-48 and Vishay `TSOP38438` pre-order geometry into the canonical application ledger; current lane state is 53 reviewed-unapproved and 48 not-started references. Earlier root-reviewed mappings cover USB-C/PD/protection, branch fuses, TVS and source selection, both eFuse roles, eight W5500 bypass capacitors, four measurement links, 26 Yageo 10 kOhm rows, and the HUB75 overlay. The largest remaining reusable families are six KEMET 100 nF rows, five TDK 22 uF rows, three Yageo 100 kOhm rows, and three Keystone test points, followed by smaller power, Ethernet, HUB75, IR, and F-RAM families. CAD, placement, mechanical/assembly, optical/powered behavior, acceptance, release, and fabrication remain denied; panel receipt and powered behavior belong to BP-502/BP-507. The IR bridge passes 4 files/50 tests with package types, lint, format, and hooks clean. | Close power, Ethernet, application, HUB75, display, and encrypted-IR receiver footprints. | `BP-030`, `BP-050`, `BP-141`, `BP-142`, `BP-143`, `BP-144`, `BP-145`, `BP-146` | Independent evidence record for every populated lane-D reference, including the BP-146 receiver path; audio remains explicit DNP with no host or I2C stub. |
