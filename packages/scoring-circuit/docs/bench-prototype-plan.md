...
| `BP-031` | blocked | Reconciled to the current 16-reference BP-103 cell: 112 channel rows plus the BP-104 connector are fail-closed as DNP-unresolved. Closure still requires manufacturer drawing/CAD, artwork, orientation review, schematic reconciliation, and BP-104 sample/fit/continuity evidence. | Close analog, protection, reference, and weapon-fixture footprints. | `BP-030`, `BP-103`, `BP-104` | Independent evidence record for every populated lane-B reference; unresolved options remain explicit DNP. |
