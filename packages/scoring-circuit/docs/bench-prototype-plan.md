...
| `BP-123` | in-progress | Dependencies `BP-120` and `BP-121` are complete. Root-reviewed commit `3ad25e2` adds a deterministic review-fragment renderer plus hash-bound schematic SVG, machine-readable zero-render-error report, and SHA-256 manifest for the exact TPS389033DSER/TPS3431SDRBR/SN74LVC2G07DCKR/BSS138AKA 11-net fragment. Regeneration is byte-stable; the source, SVG, report, canonical net digest, and all-denied BP-300/ERC/fabrication/physical authority are reconciled. Root verification passed 16 focused reset/fragment tests, package types, lint, format, artifact hashes, and diff checks. This is not canonical BP-300 ERC evidence. Next work is canonical integrated schematic source/PDF/ERC review, followed by assembled-prototype cold-start, brownout, watchdog, manual-reset, cross-domain, and power-off captures. | Close both supervisor/watchdog/reset networks. | `BP-120`, `BP-121` | Exact MPN/value schematic and cold-start, brownout, watchdog, manual-reset, cross-domain, and power-off tests. |
