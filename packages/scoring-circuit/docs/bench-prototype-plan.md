...
| `BP-031` | blocked | Root-reviewed commits `74d10b4`, `c4efd08`, `6dd2d41`, `da0f9a1`, `a6dd41e`, and `c424871` add review-only candidates for the exact TDK bypass capacitors, ADA4177 buffers, KEMET T521 reservoirs, TMUX1112 switches, all seven `TPD4E05U06DQAR` ESD shunts, and all seven `REF5025AQDRQ1` references. Root visual review corrected the TPD4 page and pin-one evidence before acceptance and verified the REF5025/D0008A identity, pin map, land example, and body-governed 7.45 mm by 5.50 mm project courtyard. The integrated 24-test REF5025/ledger/fabrication set plus package types, lint, format, source hashes, rendered geometry, and diff checks pass. Every candidate remains CAD-unacquired, orientation/process-pending, `accepted: false`, and fabrication-denied. BP-031 remains blocked only by incomplete dependency `BP-104`; remaining populated-footprint evidence, orientation, schematic reconciliation, and fabrication gates stay open. | Close analog, protection, reference, and weapon-fixture footprints. | `BP-030`, `BP-103`, `BP-104` | Independent evidence record for every populated lane-B reference; unresolved options remain explicit DNP. |
| `BP-032` | blocked | Root-reviewed commits `482e0ed`, `03d047c`, and `e9c4ec4` reconcile all 14 BP-125 support references and add exact review-only candidates for `STM32G474RET3TR`, `ISO7762FDWR`, and `ISO7721FDR`. Root visually verified the ST LQFP64 evidence plus TI pin maps, DW-16 and D-8 package outlines, HV/isolation land examples, mask/stencil guidance, and active orderable tables. Review added fail-closed page-purpose bindings for exact orderable, package, pin-one, and geometry evidence before acceptance. The integrated 16-test isolator/processor/fabrication set plus package types, lint, format, retained-source hashes, and diff checks pass. BP-032 remains blocked by incomplete dependencies `BP-123` and `BP-125`; manufacturer CAD, independent orientation/process review, remaining lane-C footprints, schematic sign-off, and fabrication evidence stay denied. | Close processor, isolation, reset, clock, and debug footprints. | `BP-030`, `BP-122`, `BP-123`, `BP-124`, `BP-125` | Independent evidence record for every populated lane-C reference. |
