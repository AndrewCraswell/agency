...
| `BP-033` | in-progress | All dependencies are complete at their pre-order design boundaries. Root-reviewed commits `796486c` and `e56e402` reuse the exact Nexperia `BSS138AKA` evidence and BP-032 project-review geometry for `Q_DISPLAY_BUFFER_A_ENABLE` and `Q_DISPLAY_BUFFER_B_ENABLE`, without duplicating the manufacturer PDF. Current lane state is 69 reviewed-unapproved and 32 not-started references. Earlier root-reviewed mappings cover USB-C/PD/protection, branch fuses, TVS and source selection, both eFuse roles, eight W5500 bypass capacitors, four measurement links, 26 Yageo 10 kOhm rows, W5500, encrypted IR, HUB75, six shared KEMET 100 nF rows, three Keystone test points, and five TDK 22 uF rows. The next delivered family awaiting root review is the two-buffer SN74AHCT245PWR pair; a narrow Yageo 100 kOhm candidate is also queued. Manufacturer CAD, artwork, board placement/fit, orientation/courtyard/DRC acceptance, release, and fabrication remain denied; panel receipt and powered behavior belong to BP-502/BP-507. Canonical MOSFET verification passes 3 files/40 tests with package types, lint, format, and hooks clean. | Close power, Ethernet, application, HUB75, display, and encrypted-IR receiver footprints. | `BP-030`, `BP-050`, `BP-141`, `BP-142`, `BP-143`, `BP-144`, `BP-145`, `BP-146` | Independent evidence record for every populated lane-D reference, including the BP-146 receiver path; audio remains explicit DNP with no host or I2C stub. |
