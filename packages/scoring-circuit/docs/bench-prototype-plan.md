...
| `BP-032` | blocked | Root-reviewed commits `482e0ed`, `03d047c`, `e9c4ec4`, and `9304d92` reconcile all 14 BP-125 support references and add exact review-only candidates for `STM32G474RET3TR`, `ISO7762FDWR`, `ISO7721FDR`, and isolated-power module `NXE1S0505MC`. Root visually verified the ST and TI evidence plus Murata page 6 mechanical drawing, five-land 2.30 mm by 1.00 mm recommendation, exact pins 1/3/7/8/14, and pin 14 no-connect rule. The integrated 16-test NXE1/processor/fabrication set plus package types, lint, format, retained-source hashes, and diff checks pass. BP-032 remains blocked by incomplete dependencies `BP-123` and `BP-125`; manufacturer CAD, independent orientation/process review, remaining lane-C footprints, schematic sign-off, and fabrication evidence stay denied. | Close processor, isolation, reset, clock, and debug footprints. | `BP-030`, `BP-122`, `BP-123`, `BP-124`, `BP-125` | Independent evidence record for every populated lane-C reference. |
