...
| `BP-104` | blocked | Fixture pinout, NC positions, continuity thresholds, and the fail-closed physical-evidence intake are frozen. Closure still requires retained and reviewed drawing/CAD artifacts, received exact parts, de-energized sample fit and labels, seven crimp/retention records, strain relief, four rejected miswire captures, and calibrated continuity evidence after `BP-010` and `BP-103`. | Freeze fixture-harness pinout and NC positions. | `BP-010`, `BP-103` | Drawing, continuity map, mating parts, labels, strain relief, and miswire test. |
