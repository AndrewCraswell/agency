...
| `BP-031` | blocked | Root-reviewed commit `74d10b4` adds an exact `CGA3E3X7R1H105K080AB` project-footprint candidate for `C_REF_IN_1` through `C_REF_IN_7`, with TDK land-pattern bounds, 0.7 mm by 0.7 mm copper, 2.1 mm span, explicit mask/paste/courtyard geometry, retained-source hashes, and rendered-artwork digest `D1DB1A50...945EC`. CAD is correctly recorded as not acquired, not unavailable; orientation, acceptance, and fabrication remain denied. Root verification passed 33 focused/dependent tests, package types, lint, format, three retained-source hashes, and diff checks. BP-031 remains blocked by incomplete dependency `BP-104`; ADA4177 and remaining populated-footprint evidence, orientation, schematic reconciliation, and fabrication gates remain open. | Close analog, protection, reference, and weapon-fixture footprints. | `BP-030`, `BP-103`, `BP-104` | Independent evidence record for every populated lane-B reference; unresolved options remain explicit DNP. |
