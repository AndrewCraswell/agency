...
| `BP-031` | in-progress | All dependencies are complete after the BP-104 pre-order fixture contract closed. Root-reviewed commits `0679719`, `ae0a7b9`, `8e6d06e`, `7b783e5`, `7d2e425`, and `627730a` add exact review-only evidence for the KEMET bypass capacitors, selected Vishay CRCW resistor families, Murata reference reservoirs, Molex weapon-fixture header, TI `TPS60400DBVR` negative-rail device, and TI `TPS7A2033PDBVR` 3.3 V regulator. Integrated verification passes 35 shared-capacitor, 54 Vishay/dependent, 43 Murata/dependent, 38 fixture/dependent, 56 TPS60400/dependent, and 42 TPS7A20/dependent tests. Remaining work is lane-B footprint/orientation evidence, canonical reference reconciliation, DC-bias/placement review, and explicit DNP closure; physical fixture construction and continuity are owned by BP-105/BP-502. | Close analog, protection, reference, and weapon-fixture footprints. | `BP-030`, `BP-103`, `BP-104` | Independent evidence record for every populated lane-B reference; unresolved options remain explicit DNP. |
| `BP-032` | blocked | Root-reviewed commit `0679719` adds exact review-only evidence for the eight BP-123 reset/supervisor/watchdog `C0603C104K3RACTU` references; commits `8b3c33a`, `43418f2`, and `a437df5` cover the ESP32 module, both TI supervisor/watchdog packages, and keyed STM32 SWD header, while earlier reviewed commits cover the STM32, isolators, isolated power, reset fanout, and reset transistors. Every candidate remains fabrication-denied. BP-123 is now complete at its pre-order design boundary; BP-032 remains blocked only by incomplete dependency `BP-125`. Remaining lane-C footprint, CAD-disposition, independent orientation/process, and processor schematic-sign-off gates stay open; physical mating and continuity move to BP-502. | Close processor, isolation, reset, clock, and debug footprints. | `BP-030`, `BP-122`, `BP-123`, `BP-124`, `BP-125` | Independent evidence record for every populated lane-C reference. |
| `BP-033` | in-progress | All dependencies are complete at their pre-order design boundaries. Root-reviewed commits `59ea3bc` and `75e9d28` add the exact Samtec `TST-108-04-G-D-RA` HUB75 pin-map/orientation overlay and a review-only WIZnet `W5500` post-July-2021 LQFP-48 project-footprint candidate. BP-146 now supplies the root-approved encrypted-IR pre-order geometry and optical-test contract. Remaining lane-D work is exact package, footprint, artwork, orientation, and canonical-reference closure across power, Ethernet, application, HUB75, and IR support rows. Panel receipt and powered behavior are owned by BP-502/BP-507. | Close power, Ethernet, application, HUB75, display, and encrypted-IR receiver footprints. | `BP-030`, `BP-050`, `BP-141`, `BP-142`, `BP-143`, `BP-144`, `BP-145`, `BP-146` | Independent evidence record for every populated lane-D reference, including the BP-146 receiver path; audio remains explicit DNP with no host or I2C stub. |
