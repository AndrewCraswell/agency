...
| `BP-031` | blocked | Root-reviewed commits `74d10b4`, `c4efd08`, `6dd2d41`, `da0f9a1`, `a6dd41e`, `c424871`, and `7529e98` add review-only candidates for the exact TDK bypass capacitors, ADA4177 buffers, KEMET T521 reservoirs, TMUX1112 switches, TPD4 ESD shunts, REF5025 references, and seven `RCWE0603R220FKEA` reference-feed resistors. Root visual review verified the Vishay RCWE pages 1-2 series range, exact global-part-number field construction, 0603 dimensions, and 0.70 mm by 1.00 mm reflow guidance while retaining the distinction between series evidence and project exact-MPN identity. The integrated 35-test RCWE/ledger/fabrication set plus package types, lint, format, source hashes, rendered geometry, and diff checks pass. Every candidate remains CAD-unacquired, orientation/process-pending, `accepted: false`, and fabrication-denied. BP-031 remains blocked only by incomplete dependency `BP-104`; remaining populated-footprint evidence, orientation, schematic reconciliation, and fabrication gates stay open. | Close analog, protection, reference, and weapon-fixture footprints. | `BP-030`, `BP-103`, `BP-104` | Independent evidence record for every populated lane-B reference; unresolved options remain explicit DNP. |
| `BP-032` | blocked | Root-reviewed commits `482e0ed`, `03d047c`, `e9c4ec4`, `9304d92`, and `5faecff` add exact review-only candidates for the STM32, both digital isolators, isolated-power module, `SN74LVC2G07DCKR` reset fanout, and both `BSS138AKA` reset transistors. Root review corrected the TI evidence model to bind physical PDF page 12 (`Addendum-Page 1`) to the active exact DCKR orderable separately from printed pages 3/11 pin and geometry evidence; Nexperia pages 2/12 bind the SOT23 pin map and land guidance. The integrated 18-test reset-support/processor/fabrication set plus package types, lint, format, retained-source hashes, and diff checks pass. BP-032 remains blocked by incomplete dependencies `BP-123` and `BP-125`; manufacturer CAD, independent orientation/process review, remaining lane-C footprints, schematic sign-off, and fabrication evidence stay denied. | Close processor, isolation, reset, clock, and debug footprints. | `BP-030`, `BP-122`, `BP-123`, `BP-124`, `BP-125` | Independent evidence record for every populated lane-C reference. |
