...
| `BP-032` | blocked | Root-reviewed BP-125 evidence now reconciles exact `RC0603FR-0710KL` selections for `R_STM_BOOT0` and `R_ESP_BOOT_PULLUP`; 12 processor-support references remain explicitly unresolved, and all CAD, artwork, orientation, schematic, and fabrication gates stay denied. Closure still waits for `BP-123` and `BP-125` plus independent evidence for every populated lane-C reference. | Close processor, isolation, reset, clock, and debug footprints. | `BP-030`, `BP-122`, `BP-123`, `BP-124`, `BP-125` | Independent evidence record for every populated lane-C reference. |
