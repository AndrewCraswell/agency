...
| `BP-034` | in-progress | A prototype-only direct-wire A/B/C landing contract for both sides has been delivered in an isolated worktree and is awaiting root diff review. It specifies exact nets, pads, test points, labels, NC exclusions, de-energized rework, clamp-only strain loading, continuity/isolation thresholds, and miswire rejection while keeping USB-C PD unchanged. The owner-validated OK Fencing weapon cable remains accepted. This is not yet committed or approved; production socket selection and all received-sample, mounting, mate/unmate, continuity, retention, and strain evidence remain open. | Complete pre-order connector sample, mate, fit, pinout, and continuity review. | `BP-050`, `BP-104`, `BP-124`, `BP-141`, `BP-143` | Received sample identities, mating-part checks, orientation/photos, mechanical fit, harness pinout, strain relief, and continuity archive. No automated scoring fixture is required yet. |
