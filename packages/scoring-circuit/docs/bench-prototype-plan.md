...
| `BP-033` | in-progress | All dependencies are complete at their pre-order design boundaries. Root-reviewed commits `ab917bd` and `fcbbea4` retain and link exact primary evidence for all five application-regulator support rows: the TI regulator, Coilcraft inductor, TDK input capacitor, Würth VCC capacitor, and Yageo discharge resistor. Current lane state is 81 reviewed-unapproved and 20 not-started references. Earlier root-reviewed mappings cover USB-C/PD/protection, branch fuses, TVS and source selection, both eFuse roles, eight W5500 bypass capacitors, four measurement links, 26 Yageo 10 kOhm rows, three Yageo 100 kOhm rows, two encrypted-IR resistors, W5500, encrypted IR, HUB75, six shared KEMET 100 nF rows, three Keystone test points, five TDK 22 uF rows, two BSS138 display-enable MOSFETs, and both display buffers. The remaining families are partitioned into display-limiter, W5500-support, reset, F-RAM, and connector slices. Manufacturer CAD authority, placement, switching-loop/thermal review, schematic integration, release, and fabrication remain denied. Canonical verification passes 3 files/49 tests with package types, lint, format, and hooks clean. | Close power, Ethernet, application, HUB75, display, and encrypted-IR receiver footprints. | `BP-030`, `BP-050`, `BP-141`, `BP-142`, `BP-143`, `BP-144`, `BP-145`, `BP-146` | Independent evidence record for every populated lane-D reference, including the BP-146 receiver path; audio remains explicit DNP with no host or I2C stub. |
