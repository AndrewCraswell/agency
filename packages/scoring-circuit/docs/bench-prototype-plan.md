...
| `BP-146` | blocked | Root-reviewed Vishay package drawing, pin/lead geometry, three source digests, assembly guidance, and optical-window formula evidence are committed fail-closed. Closure still requires an accepted board land pattern/CAD/drill/pad/orientation review, accepted optical layout and physical panel coupon, and range, angle, latency, flood, reset, and power-off measurements. | Select and freeze the encrypted IR remote receiver path and optical test interface. | `BP-126`, `BP-142`, `BP-145` | Exact receiver/demodulator or decoder, wavelength/carrier, supply/filter/protection, connector or optical window assumptions, test points, footprint, current budget, numeric range/angle/light/latency targets, and stuck/noise/power-off behavior are reviewed. |
