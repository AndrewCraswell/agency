...
| `BP-031` | blocked | The 112 repeated-cell rows now share 13 hash-bound M4-04 manufacturer-source identities through 91 fail-closed links; 21 rows still lack source records, and all 113 records remain DNP-unresolved. Closure still requires exact source review, manufacturer CAD, artwork, orientation, schematic reconciliation, and BP-104 sample/fit/continuity evidence. | Close analog, protection, reference, and weapon-fixture footprints. | `BP-030`, `BP-103`, `BP-104` | Independent evidence record for every populated lane-B reference; unresolved options remain explicit DNP. |
