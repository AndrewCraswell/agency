...
fixture LINE -> TPD4E05U06DQAR shunt -> CRCW060322R0FKEAHP 22 ohm -> TMUX1112
  -> ADA4177-1 unity buffer on common-ground +5 V / -5 V
...
- The normative 0-ohm state and the 450/475/500-ohm region are within the
  published normal input ranges of the `ADA4177-1ARZ` buffer and
...
The common-ground core retains `TPS60400DBVR`,
`REF5025AQDRQ1`, `TPD4E05U06DQAR`, `CRCW060322R0FKEAHP`,
`TMUX1112PWR`, `ERA3AEB2491V`, `ADA4177-1ARZ`,
...
`ADA4177-1ARZ`, `R_SAR` `CRCW060320R0FKEAHP`, and `U_SAR` `ADS8881IDGS`.
...
3. BP-103 must decide how seven converters or an alternative reviewed
   ...
   crosstalk, common-ground analog-power loading, and fault containment.
