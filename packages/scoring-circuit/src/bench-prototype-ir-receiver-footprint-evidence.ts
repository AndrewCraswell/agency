...
export function validateBenchPrototypeIrReceiverFootprintEvidence(value: unknown): true {
  ...
  if (
    ...
    candidate.rootReleaseCandidate.decisionRecordArtifactPath !== "docs/esp32-prototype-backlog.md#bp-126" ||
    ...
    candidate.preorderDesignReview.decisionRecordArtifactPath !== "docs/esp32-prototype-backlog.md#bp-126" ||
