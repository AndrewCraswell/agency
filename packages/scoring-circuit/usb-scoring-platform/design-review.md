...
stock/prices must be refreshed at ordering. This supersedes the earlier C64/C65 candidate-only procurement note, not the
still-open C56/header substitutions. No JLCPCB draft or cart was changed. Verification:
...
| P2       | Stocked same-footprint headers and capacitor alternatives — proposal                   | C64/C65 changed to reviewed Yageo CC0603JRNPO9BN180; ERC/DRC/parity/unconnected all zero; fresh 230-part export matches. J2/J6 and C56 remain open. JLCPCB draft is unchanged.                                                                                                                   | May reduce minimum-order waste and delay without adding components. Savings unpriced until equivalent parts and assembly quantities are verified. | Reconcile C107040 in the supplier draft before ordering. Continue separate J2/J6 and C56 reviews.                                                                                                               |
