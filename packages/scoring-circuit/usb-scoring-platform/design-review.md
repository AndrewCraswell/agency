...
| P1       | Physical footprints and assembly orientation — corrected connector/body defects        | J7/J8 and U13/BZ1 fixes pass native DRC. Q1-Q6 and D3-D9 package/pin comparisons found no fit or pin-map defect. Remaining overlays and installed cable envelopes are not all complete.                                                                                     | Removes identified fit/clearance defects without changing circuit functions.                                                                      | Finish remaining package overlays and assembler placement/cable acceptance; do not treat missing CAD as a missing BOM part.                                                                                     |
