...
Started 8 September 2026. Review the current native KiCad board and the `output/fixed-regulator-review/` assembly
...
| P2       | Current versus historical README component descriptions — confirmed drift              | Historical text still describes ON tied to VLO and old passive counts/identities, while U21 now controls ON and current export contains 223 parts.                                                                                                                          | Wrong assembly or troubleshooting decisions; no BOM cost.                                                                                         | Consolidate current build instructions; use exact current BOM, not historical narratives, for procurement.                                                                                                      |
