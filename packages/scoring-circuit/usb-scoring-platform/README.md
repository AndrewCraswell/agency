...
resistors. The remaining 56 unrouted items concern the conductor/sense interface.
...
export and connected-pin transfer checks succeeded. DRC reports **56 unrouted items** and **four other findings**, all
