...
;(function () {
  ...
  theme.announcementBar = (function () {
    ...
    function initSticky() {
      ...
      if (
        barSection &&
        barSection.previousElementSibling &&
      ...
      triggerClick: function (evt) {
        ...
        if (this.inSlideshow) {
          ...
          for (var i = 0; selectedSlide && i < this.items.length; i++)
            if (selectedSlide.contains(this.items[i].el)) {
              openIndex = i + 1
              break
            }
        } else {
      ...
      init: function () {
        ...
        if (slides.length > 1) {
          var sliderArgs = {
            ...
            autoPlay:
              this.slideshow.dataset.autoplay === "true" && !theme.a11y.prefersReducedMotion()
  ...
  theme.Collection = (function () {
    ...
    Collection.prototype = Object.assign({}, Collection.prototype, {
      ...
      fetchOpenCollasibleFilters: function () {
        return Array.from(document.querySelectorAll(`${selectors.sidebar} ${selectors.trigger}.${classes.isOpen}`)).map(
  ...
  theme.Product = (function () {
    ...
    Product.prototype = Object.assign({}, Product.prototype, {
      ...
      onBreakpointVideoChange: function () {
        var slide =
          this.cache.mainSlider.querySelector(selectors.currentSlide) ||
      ...
      _isActiveSlide: function (id) {
        return this.cache.mainSlider.querySelector(selectors.currentSlide + " #" + id) || this._isFirstSlide(id)
      },
