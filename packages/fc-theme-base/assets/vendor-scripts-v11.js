...
;(!(function (t, e) {
    ...
    function (t, e) {
      ;(function (e) {
        ...
        var s =
          ...
          g =
            "object" == ("undefined" == typeof self ? "undefined" : s(self)) && self && self.Object === Object && self,
        ...
        t.exports = function (t, e, o) {
          ...
          if ("function" != typeof t) throw new TypeError(a)
          return (
            n(o) && ((r = "leading" in o ? !!o.leading : r), (s = "trailing" in o ? !!o.trailing : s)),
        ...
        t.forEach(function (t, o) {
          !(function (t, e, i) {
            ...
            e > t.position
              ...
              : void 0 !== n && ("false" === n || (!i && "true" !== n)) && t.node.classList.remove("aos-animate")
          })(t, n + i, e)
        })
      }
    },
    ...
    return (function e(i) {
      function n(e, o, r) {
        ...
        if ("undefined" != typeof document) {
          ...
          e || (s = {})
          for (
            var u = document.cookie ? document.cookie.split("; ") : [], d = /(%[0-9A-Z]{2})+/g, h = 0;
            h < u.length;
            h++
          ) {
            var p = u[h].split("="),
    ...
    function s(a) {
      if (
        ...
        if ("none" == l.display)
          return (function () {
            for (
              var t = { width: 0, height: 0, innerWidth: 0, innerHeight: 0, outerWidth: 0, outerHeight: 0 }, n = 0;
              n < i;
              n++
            )
              t[e[n]] = 0
  ...
  (function (t, e) {
    ...
    ;((o.prototype = Object.create(i.prototype)),
      ...
      (o.prototype.removeDots = function (t) {
        this.dots.splice(this.dots.length - t, t).forEach(
          function (t) {
  ...
  (function (t, e) {
    "function" == typeof define && define.amd
      ? define(
          "flickity/js/index",
          ["./flickity", "./drag", "./prev-next-button", "./page-dots", "./player", "./add-remove-cell"],
          e
        )
    ...
    return function (t, e, i, n) {
      var o = {
        ...
        detectFeatures: function () {
          ...
          for (
            var l, c, u = ["transform", "perspective", "animationName"], d = ["", "webkit", "Moz", "ms", "O"], h = 0;
            h < 4;
            h++
          ) {
            e = d[h]
      ...
      var a,
        ...
        It = function (t) {
          et &&
            (t &&
              (g > r.currItem.fitRatio ? xt || (Ke(r.currItem, !1, !0), (xt = !0)) : xt && (Ke(r.currItem), (xt = !1))),
            _t(et, dt.x, dt.y, g))
        },
        At = function (t) {
          t.container && _t(t.container.style, t.initialPosition.x, t.initialPosition.y, t.initialZoomLevel, t)
        },
        Tt = function (t, e) {
          e[_] = y + t + "px, 0px" + b
        },
        ...
        $t = {
          ...
          init: function () {
            if (!a && !l) {
              ...
              for (
                (N.animationName && N.transform && !n) || (s.showAnimationDuration = s.hideAnimationDuration = 0),
                  i = 0;
                i < yt.length;
                i++
              )
          ...
          goTo: function (t) {
            var e = (t = St(t)) - u
            ;((gt = e), (u = t), (r.currItem = je(u)), (pt -= e), Mt(mt.x * pt), Gt(), (it = !1), r.updateCurrItem())
          },
          next: function () {
            r.goTo(u + 1)
          },
              ...
              if (!(t && i < 2)) {
                ...
                for (var n = 0; n < i; n++)
                  gt > 0
                    ...
                    : ((e = S.pop()), S.unshift(e), h--, Tt(h * mt.x, e.el.style), r.setContent(e, u + i - n - 1 - 1))
                if (et && 1 === Math.abs(gt)) {
                  var o = je(E)
          ...
          return (
            I
              ...
              : t.type.indexOf("touch") > -1
                ? t.touches &&
                  t.touches.length > 0 &&
                  ((Ce[0] = be(t.touches[0], Se)), t.touches.length > 1 && (Ce[1] = be(t.touches[1], Ee)))
            ...
            (s.allowPanToNext || g === r.currItem.initialZoomLevel) &&
              (et
                ? "h" !== nt ||
                  ...
                  X ||
                  (c
                    ? (l > tt.min[t] && ((i = s.panEndFriction), tt.min[t] - l, (n = tt.min[t] - ut[t])),
                      (n <= 0 || d < 0) && We() > 1
                        ? ((a = u), d < 0 && u > oe.x && (a = oe.x))
                        : tt.min.x !== tt.max.x && (o = l))
                    : (l < tt.max[t] && ((i = s.panEndFriction), l - tt.max[t], (n = ut[t] - tt.max[t])),
                      (n <= 0 || d > 0) && We() > 1
                        ? ((a = u), d > 0 && u < oe.x && (a = oe.x))
                        : tt.min.x !== tt.max.x && (o = l)))
                : (a = u),
        ...
        Ae = function (t) {
          ...
          var c = -1
          if (
            (0 === l && ((B = !1), o.unbind(window, p, r), fe(), J ? (c = 0) : -1 !== ce && (c = kt() - ce)),
            (ce = 1 === l ? kt() : -1),
          ...
          var t,
            ...
            i = {
              ...
              calculateSwipeSpeed: function (n) {
                ;(re.length > 1 ? ((t = kt() - j + 50), (e = re[re.length - 2][n])) : ((t = kt() - R), (e = ie[n])),
              ...
              panAnimLoop: function () {
                if (
                  ...
                  return ((dt.x = Math.round(dt.x)), (dt.y = Math.round(dt.y)), It(), void Xt("zoomPan"))
              }
            }
          return i
        },
        ...
        ze = function (t, e) {
          ...
          return (
            ...
            Kt("mainScroll", ue.x, h, d, o.easing.cubic.out, Mt, function () {
              ;(Gt(), (it = !1), (ae = -1), (i || ae !== u) && r.updateCurrItem(), Dt("mainScrollAnimComplete"))
            }),
      ...
      var Fe,
        ...
        Ve = function (e, i, n, a) {
          ...
          ;((p = c),
            ...
            n ||
              ((g = l.w / e.w), (dt.x = l.x), (dt.y = l.y - L), (r[f ? "template" : "bg"].style.opacity = 0.001), It()),
            Yt("initialZoom"),
                  ...
                  var i = l.w / e.w,
                    ...
                    c = function (e) {
                      ;(1 === e
                        ...
                        : ((g = (i - s) * e + s), (dt.x = (l.x - r.x) * e + r.x), (dt.y = (l.y - F - r.y) * e + r.y)),
                        It(),
                        f ? (t.style.opacity = 1 - e) : Pt(a - e * a))
                    }
                  p ? Kt("initialZoom", 0, 1, d, o.easing.cubic.out, c, h) : (c(1), (Fe = setTimeout(h, d + 20)))
                } else
                  ((g = e.initialZoomLevel),
                    Lt(dt, e.initialPosition),
                    It(),
          ...
          setContent: function (t, e) {
            ...
            if (l) {
              ...
              if (
                ...
                l.src &&
                  !l.loadError &&
                  (((n = o.createEl("pswp__img", "img")).style.opacity = 1), (n.src = l.src), Ke(l, n), Xe(0, l, c, n))
              else {
                if (
              ...
              ;(Ue || e !== u ? At(l) : ((et = c.style), Ve(l, n || l.img)), (t.el.innerHTML = ""), t.el.appendChild(c))
            } else t.el.innerHTML = ""
          },
        ...
        publicMethods: {
          ...
          onTapRelease: function (t, e) {
            ...
            if (e && !Y && !Z && !Zt) {
              ...
              if (
                Je &&
                (clearTimeout(Je), (Je = null), (i = r), (n = ti), Math.abs(i.x - n.x) < 25 && Math.abs(i.y - n.y) < 25)
              )
          ...
          (function () {
            ...
            ;(d("onVerticalDrag", function (t) {
              ...
              d("onPinchClose", function (e) {
                S && e < 0.9 ? (x.hideControls(), (t = !0)) : t && !S && e > 0.9 && x.showControls()
              }),
                ...
                (f = setTimeout(
                  function () {
                    t.currItem && t.currItem.loading
                      ? (!t.allowProgressiveImg() || (t.currItem.img && !t.currItem.img.naturalWidth)) && N(!1)
                      : N(!0)
                  },
        ...
        (x.update = function () {
          ;(S && t.currItem
            ? (x.updateIndexIndicator(),
              g.captionEl && (g.addCaptionHTMLFn(t.currItem, o), P(o, "caption--empty", !t.currItem.title)),
              (w = !0))
            : (w = !1),
            E || A(),
            _())
  ...
  (function (t, e) {
          ...
          i.keyboardSupport &&
            ...
            o.addEventListener("keydown", function (t) {
              return (function (t, e) {
                ...
                return (
                  dt(e, C.toStepping(a), !0, !0), rt("slide", e), rt("update", e), rt("change", e), rt("set", e), !1
                )
              })(t, e)
            })),
      ...
      function H(e) {
        ...
        return (
          ...
          n.forEach(function (i, r) {
            ...
            for (
              w && (s = C.xNumSteps[r]), s || (s = x - b), void 0 === x && (x = b), s = Math.max(s, 1e-7), u = b;
              u <= x;
              u = Number((u + s).toFixed(7))
            ) {
              for (
                g = (p = (h = C.toStepping(u)) - c) / (e.density || 1), y = p / (v = Math.round(g)), d = 1;
                d <= v;
                d += 1
              )
      ...
      function G(t, e, n, o) {
        var r = function (r) {
            ...
            return (
              ...
              (a = i.cssClasses.tap),
              !(
                (s.classList ? s.classList.contains(a) : new RegExp("\\b" + a + "\\b").test(s.className)) &&
                !o.doNotReject
              ) &&
      ...
      function st(t, e, n, o, r, s) {
        ...
        return (
          d.length > 1 &&
            ...
            (o && e > 0 && ((a = C.getAbsoluteDistance(t[e - 1], i.margin, !1)), (n = Math.max(n, a))),
            r && e < d.length - 1 && ((a = C.getAbsoluteDistance(t[e + 1], i.margin, !0)), (n = Math.min(n, a)))),
          d.length > 1 &&
            i.limit &&
            (o && e > 0 && ((a = C.getAbsoluteDistance(t[e - 1], i.limit, !1)), (n = Math.min(n, a))),
            r && e < d.length - 1 && ((a = C.getAbsoluteDistance(t[e + 1], i.limit, !0)), (n = Math.max(n, a)))),
          i.padding &&
            (0 === e && ((a = C.getAbsoluteDistance(0, i.padding[0], !1)), (n = Math.max(n, a))),
            e === d.length - 1 && ((a = C.getAbsoluteDistance(100, i.padding[1], !0)), (n = Math.min(n, a)))),
    ...
    ;((t.create = Y), (t.cssClasses = S), (t.default = G), Object.defineProperty(t, "__esModule", { value: !0 }))
  }))
