...
| [preferred-cli-tooling.md](preferred-cli-tooling.md) | CLI setup, authentication, use cases, project-local tools, and the boundary between CLIs and AI/MCP access.                                                 |
