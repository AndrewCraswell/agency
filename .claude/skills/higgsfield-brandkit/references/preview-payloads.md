...
After the script succeeds, follow `inline-widgets.md`: screenshot each HTML board to a local PNG, inspect it, show the
PNG inline when supported, and provide the absolute editable HTML path.
