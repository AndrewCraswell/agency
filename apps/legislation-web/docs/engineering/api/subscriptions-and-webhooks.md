...
The [notification experience](../../product/notification-experience.md) selects Novu for planned in-app and email delivery.
Application subscriptions and event matching remain authoritative. This does not change the wire schemas, batching
windows, or signed webhook contract below. Recipient projections, effective preferences, provider status mapping,
and cross-subscription deduplication require the explicitly listed contract additions before implementation.
