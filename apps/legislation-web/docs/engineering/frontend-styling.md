...
[legislation verification gate](../operations/testing.md#full-verification). Build integration changes also need
`pnpm --filter legislation-web build`. Inspect desktop/mobile,
