...
| How do I run agent evaluations?                        | [Agent evaluations](operations/agent-evaluations.md): Langfuse-managed evaluation, frozen fixtures, and browser scenario timeout recovery with independent diagnostic receipts |
