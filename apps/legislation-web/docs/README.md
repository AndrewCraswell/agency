...
- [Single-root presentation rendering and trust boundaries](engineering/architecture-decisions.md#single-root-presentation-boundary)
...
- [Search/diffs, temporal filters and canonical model execution metadata](engineering/api/search-and-diffs.md),
...
| How does document comparison work?                     | [Diffing package](../../../packages/legislation-diffing/README.md) and [comparison API](engineering/api/search-and-diffs.md#post-apidocument-diffs-comparedocumentversions): literal full-text diffs and Storybook prototypes |
