...
| How do I run agent evaluations?                        | [Agent evaluations](operations/agent-evaluations.md): Langfuse-managed evaluation, frozen fixtures, authored follow-up scope, and browser timeout diagnostic receipts |
