...
See [Goal-driven browser scenarios](scenario-harness.md) for authoring, integrated-browser execution, durable
checkpoints, and resumption. Planner completion is separate from research quality evaluation. Historical campaign
journals keep their original contracts and outcomes; do not rewrite them as new-harness successes.
