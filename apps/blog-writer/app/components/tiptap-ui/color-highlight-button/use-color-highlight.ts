...
// --- Icons ---
import { HighlighterIcon } from "@/components/editor/editor-icons"
...
/**
 * Highlights are applied as a `highlight` mark. The node background variant this component also shipped
 * with was removed along with its extension, because block background colours do not survive the article
 * sanitizer.
 */
...
export interface UseColorHighlightConfig {
   ...
   * - "mark": Uses the highlight mark extension
   * @default "mark"
   */
  mode?: HighlightMode
  /**
