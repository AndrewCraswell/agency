...
SELECT
  "run_id",
  '{"agentRuntime":{"provider":"openhands","version":"ghcr.io/openhands/agent-server@sha256:6301c75380733e83c7291a9a258de5fc04a99d940894db7b157e845a8cc03dcc"},"decisions":{"phase8":{"code":"no-approved-microsoft-candidate-or-parity-evidence","evidence":"docs/agent-platform/integration-workflow-platform-plan.md#deferred-runtime-decisions","status":"deferred"},"phase9":{"code":"no-qualifying-azure-workspace-entry-driver","evidence":"docs/agent-platform/integration-workflow-platform-plan.md#deferred-runtime-decisions","status":"deferred"}},"orchestrator":{"provider":"langgraph","version":"1.4.7"},"selectionVersion":1,"workspace":{"provider":"daytona","version":"0.196.0"}}'::jsonb,
  "created_at"
