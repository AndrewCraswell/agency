...
describe("Congress committee report normalization", () => {
  it.each([
    ...
    [
      "117th Congress REPORT 117-130 September 27, 2021.--Committed to the Committee of the Whole House on the State of the Union and ordered to be printed",
      "2021-09-27"
    ],
    ...
    [
      "117th Congress REPORT January 1, 2022.--Ordered to be printed February 1, 2022.--Ordered to be printed",
      undefined
    ]
