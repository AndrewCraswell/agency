...
| API foundation | Strict legal-search schemas, organization-gated internal search and exact-version text HTTP/client/MCP delivery. Coverage/discovery, public legal search and deployed canaries remain open. See [reader delivery](../../../legislation-web/docs/regulations/legal-text-serving.md). |
...
| HTTP and MCP | [HTTP and TOOLS tasks](../../../legislation-web/docs/regulations/api-mcp-production-tasks.md) | Shared contracts; INDEX query service | API-01–14; MCP-01–07; APP |
...
After the complete coherent deliverable, run relevant owner-local checks and the
[single final legislation gate](../../../legislation-web/docs/operations/testing.md#full-verification). Do not create tests that
