...
- [ ] Deploy the session reconciler only after the active Alaska event chain drains. Apply the exact AK34 and NC2025 inventories, verify repeat no-op readback and bill-detail acceptance, then investigate Alaska's 49 held timelines from newer retained source evidence rather than weakening timeline equality.
