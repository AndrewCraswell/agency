...
- [ ] Alaska event promotion is actively draining the frozen inventory. Batch `e9fe6daf97853a555e0b9ce8dbcf8a8d145732e75dac4d9985561ea0bf310bfb` completed as `run_06gatamkvm01n6edvevaqvpc01`: Azure execution `leg-dev-openstates-scraper-rr9ht` succeeded and ten exact source occurrences promoted transactionally. Its distinct successor `8a9cb0ae40821c8163abd3eebb60031c94b6e6fefe8a29648375b29c5bfdd44f` completed as `run_06gatavpi6an2opg772vme5m01`, promoted ten more and alone dispatched `run_06gatb73e3urgvi6is22338u01`. At the first two measured batch rates the drain is approximately 4.5 to 5.5 hours. Do not claim whole-inventory meeting readiness until all 285 receipts reconcile, relationship/readiness promotion passes and public API/MCP reads succeed.
