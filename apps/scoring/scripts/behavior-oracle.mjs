...
const fixedArtifacts = [
  ...
  ["oracle-generator", "apps/scoring/scripts/behavior-oracle.mjs"],
  ...
  ["simulator", "apps/scoring/simulator/index.html"],
  ["simulator", "apps/scoring/simulator/components.json"],
  ["simulator", "apps/scoring/simulator/tsconfig.json"],
  ["simulator", "apps/scoring/simulator/vite.config.ts"],
  ["simulator", "apps/scoring/simulator/src/App.test.tsx"],
  ["simulator", "apps/scoring/simulator/src/App.tsx"],
  ["simulator", "apps/scoring/simulator/src/components/DeveloperDisplay.test.tsx"],
  ["simulator", "apps/scoring/simulator/src/components/DeveloperDisplay.tsx"],
  ["simulator", "apps/scoring/simulator/src/components/ui/badge.tsx"],
  ["simulator", "apps/scoring/simulator/src/components/ui/button.tsx"],
  ["simulator", "apps/scoring/simulator/src/components/ui/dropdown-menu.tsx"],
  ["simulator", "apps/scoring/simulator/src/components/ui/input.tsx"],
  ["simulator", "apps/scoring/simulator/src/components/ui/tooltip.tsx"],
  ["simulator", "apps/scoring/simulator/src/format.test.ts"],
  ["simulator", "apps/scoring/simulator/src/format.ts"],
  ["simulator", "apps/scoring/simulator/src/lib/utils.ts"],
  ["simulator", "apps/scoring/simulator/src/main.tsx"],
  ["simulator", "apps/scoring/simulator/src/simulator-api.ts"],
  ["simulator", "apps/scoring/simulator/src/styles.css"],
  ["display-projection", "apps/scoring/scripts/serve-scenario-observatory.mjs"],
  ["simulator", "apps/scoring/src/observatory-identity.ts"],
  ["simulator", "apps/scoring/src/observatory-identity.test.ts"],
...
const testCommands = [
  ...
  "pnpm --filter scoring test:simulator",
