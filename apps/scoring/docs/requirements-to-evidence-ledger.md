...
| **R-07 M0-05, M0-07, and replay.** Immutable qualified-hit, off-target, rejection, line-fault, reset, uncertainty, and calibration records; bounded captures; provenance; deterministic scenarios; atomic persistence; replay without re-decision. | Rules, data, and QA; M0-05, M0-07, M2-04, M2-08, M2-11, M3-09, M6-05, M6-06, M8-03. | U, S, E, D, P | Schema round trips and rejects unknown values; golden scenario manifest; fault and power-fail reports; reboot/update replay corpus; board records matching host decisions; production retention audit. | Decision-record schema and 22 active host scenarios across epee, foil, and sabre are baseline inputs. Several composite traceability rows remain planned because resistance acquisition, diagnostics, physical outputs, and complete endpoint matrices are not yet evidenced; capture production, atomic persistence, and board journal also remain planned. | Rule endpoints and line contract; no raw-sample re-decision; storage authentication, retention, export, and correction policy. |
...
| **R-09 M0-11 security, two-chip update, identity, debug, and service.** Target-bound authenticated ESP32 and STM32 images, a signed product compatibility manifest, independent inactive-bank/slot rollback, identity and key custody, bounded parsers, physical authorized debug, and service reports without secrets. | Security, firmware, and service; M0-11, M3-10, EVO-09 through EVO-16, M6-03, M6-07, M7-08, M8-02, M8-07. | U, S, E, D, P | Threat-model tests; signed-image, manifest, and wrong-target rejection; ESP32 candidate-health rollback; interrupted update/rollback on both processors; provisioning audit; parser fuzz/penetration review; debug-state and service recovery audit. | ESP32 security profile is proposed; STM32 signed dual-bank path, product compatibility manifest, key separation, target implementation, and power-cut evidence are open. | Each processor verifies its own image; the ESP32 may deliver but cannot unilaterally activate STM32 scoring firmware; compatibility, idle-only activation, anti-rollback floors, recovery, custody separation, PA13/PA14, and USB Serial-JTAG policy require review; no network-triggered debug or arbitrary output control. |
