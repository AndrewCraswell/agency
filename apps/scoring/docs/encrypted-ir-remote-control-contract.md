...
| `RC-09` | ready | Dependencies RC-01, RC-05, and M1-06 are done; ready to implement manual/automatic rearm, weapon request, side swap, Reset All/New Bout, and safe-idle sleep with STM32 request correlation. | Implement manual/automatic rearm, weapon request, side swap, Reset All/New Bout, and safe-idle sleep. | `RC-01`, `RC-05`, M1-06 | STM32 request/accept/reject correlation passes; side swap is atomic; new bout changes `boutId`; sleep and destructive actions fail closed while unsafe. |
