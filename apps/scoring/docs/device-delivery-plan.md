...
| M2-07 | done | Delivered and root-approved: only link-issued callback capabilities can reach the virtual ESP32 receiver; forged, cloned, mutated, reordered, or caller-cleared snapshots cannot create or alter STM32 decisions. | Virtual ESP32 receiver and authority guard | M0-04, M2-06 | Accepts valid records exactly once and cannot create, alter, or reclassify a scoring decision |
