...
| BT-04 | done | Delivered: Root-reviewed canonical-scenario compiler emits detached, deeply frozen integer-microsecond stimulus and authored expectation timelines without importing a scorer or copying timing constants. It preserves post-stimulus observation windows, rejects malformed, unsupported, unsafe, non-monotonic, duplicate, unknown-reference, and over-capacity data fail-closed, and passes 6 focused tests plus app types, lint, and format checks. | Tester sequence language and canonical-scenario compiler | M0-07, M2-12, BT-01 | Scenarios compile deterministically without copied timing constants; invalid, unsupported, or unsafe steps fail closed |
