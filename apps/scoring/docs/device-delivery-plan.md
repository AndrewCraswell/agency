...
| M0-07 | blocked | Root-reviewed integrity unit is isolated for commit: version 1.1 manifest digests, strict identity/mapping checks, and adversarial cases are present; final closure waits for M2-01's overlapping runner changes to rebase and the complete scenario suite to pass. | Golden scenario file format and corpus manifest | M0-01, M0-02, M0-05 | A scenario can express line transitions, expected events, expected non-events, and boundary uncertainty without code |
