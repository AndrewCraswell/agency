...
| M4-04 | in-progress | Dependencies M4-02 and M4-03 are complete. Root-reviewed commit `f85f5c3` expands the hash-bound manufacturer evidence with exact Panasonic `ERA3AEB2491V` package/land guidance and documented CAD absence, exact Analog Devices `ADA4177-1ARZ` identity/package evidence, and exact TDK `CGA3E3X7R1H105K080AB` source evidence. Static ERC and the 45-reference/26-MPN review queue remain intact; no footprint authority was inferred. Next work is the remaining exact-source dispositions, project artwork overlays, and independent footprint/orientation review. | Single-channel sensing coupon schematic and verified footprints | M4-02, M4-03 | ERC passes; footprints are checked against manufacturer drawings by a second reviewer |
