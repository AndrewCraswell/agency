...
| M4-04 | blocked | Static source-bound ERC and the exact 45-reference BOM/review queue are delivered and root-reviewed; completion remains blocked until exact manufacturer drawings/CAD, generated artwork overlays, and independent footprint/orientation reviews are recorded for every reference. | Single-channel sensing coupon schematic and verified footprints | M4-02, M4-03 | ERC passes; footprints are checked against manufacturer drawings by a second reviewer |
