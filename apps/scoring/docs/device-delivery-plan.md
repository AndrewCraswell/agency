...
| M4-11 | blocked | Exact RJ45, USB-C, and internal locking-power identities are reconciled in a fail-closed source audit; release remains blocked on acquired drawings/CAD, land-pattern and enclosure overlays, chassis fasteners, service access, and strain-relief evidence. | Communications and power connector CAD/footprint verification | None | RJ45, USB-C, locking power, shield tabs, fasteners, service access, and strain relief match manufacturer drawings |
