...
The immutable M0-11 authority, update, identity, debug, parser, recovery, and
power trust boundaries are specified in [product-threat-model.md](product-threat-model.md).
