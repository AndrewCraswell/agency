...
| --- | --- | --- |
| [Congress.gov API](https://api.congress.gov/) | Federal members, service context, bills, amendments, committees, and related legislative records. | Authoritative federal acquisition source. Archive responses and serve normalized local records. |
| [Open States scrapers](https://github.com/openstates/openstates-scrapers) and [people data](https://github.com/openstates/people) | State officials, roles, memberships, committees, bills, votes, and events. | Self-hosted normalized state acquisition. Do not depend on the hosted 250-request quota for routine sync. |
