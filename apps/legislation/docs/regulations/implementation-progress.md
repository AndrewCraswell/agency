...
require explicit permission for lexical fallback. See [search serving](legal-search-serving.md) for exact limitations.
...
[pagination contract](edition-search-canary.md). Focused search tests passed (14 tests); service typecheck and scoped
...
See [cross-edition lexical retrieval](edition-search-canary.md). This advances INDEX-02/06/07; publication/default-current
...
[edition and provision browsing](legal-edition-browsing.md). Code/edition detail and coverage reporting remain open.
...
filters, page size, rights hashes and visible catalog. See [the discovery contract](legal-code-discovery.md).
...
The [exact-version text API](legal-text-serving.md) now has an explicit Next route, organization-gated database service,
