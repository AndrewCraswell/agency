...
Seven operations were removed: all four calendar operations, both meeting-outcome operations, and representative lookup. The public inventory is now 81 operations: 76 retain prior acceptance and five remain open (passage search, organization bills, organization meetings, meeting detail, agenda-item detail). Historical evidence below describes earlier releases and is not the current endpoint inventory. Removal deployment acceptance is pending. No stored data or vector indexes were deleted.
