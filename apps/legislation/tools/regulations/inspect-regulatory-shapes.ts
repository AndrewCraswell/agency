...
import { regulatoryParserContract } from "../../src/ingestion/regulations/parser-contract.js"
import {
...
import { storedLegalSourceBlocks } from "../../src/ingestion/regulations/reader-text.js"
import {
  assertRights,
  provisionContent,
  regulatoryStorageContract
} from "../../src/ingestion/regulations/storage-contract.js"
...
async function fingerprint() {
  const dependencies = regulatoryDependencyFingerprint(
    await readFile(new URL("../../../../pnpm-lock.yaml", import.meta.url), "utf8"),
    "apps/legislation",
    ["@huggingface/tokenizers", "cheerio", "fast-xml-parser", "pg", "tiktoken", "tiny-invariant", "tsx", "yaml", "zod"]
  )
  return digest(
    (
      await Promise.all(
        [
          ...
          new URL("../../src/ingestion/regulations/contracts.ts", import.meta.url),
          ...
          new URL("../../src/models/embedding-preparation.ts", import.meta.url),
          new URL("../../src/models/embedding-tokenizer.ts", import.meta.url),
          new URL("../../src/models/embedding-routing.ts", import.meta.url),
          new URL("../../src/models/openrouter-embeddings.ts", import.meta.url),
          new URL("../../src/ingestion/regulations/reader-contract.ts", import.meta.url),
          new URL("../../src/ingestion/regulations/reader-text.ts", import.meta.url),
          new URL("../../src/ingestion/regulations/table-passages.ts", import.meta.url),
          new URL("../../src/ingestion/regulations/parser-contract.ts", import.meta.url),
          new URL("../../src/ingestion/regulations/storage-contract.ts", import.meta.url)
