...
vi.mock("../../db/database.js", async (original) => ({
  ...(await original<typeof import("../../db/database.js")>()),
...
const originalDatabase = await vi.importActual<typeof import("../../db/database.js")>("../../db/database.js")
