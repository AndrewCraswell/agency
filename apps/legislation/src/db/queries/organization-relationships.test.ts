...
describe("organization collection queries", () => {
  it("scopes organizations to a jurisdiction and applies a strict name keyset", () => {
    ...
    expect(generated).toContain('"organizations"."source_is_official" is not null')
    expect(generated).toContain('"organizations"."source_provider" is not null')
    expect(generated).toContain('"organizations"."source_retrieved_at" is not null')
    expect(generated).toContain('"organizations"."source_url" is not null')
    expect(generated).toContain('"organizations"."is_active" is not null')
    expect(generated).toContain('"organizations"."classification" in')
    expect(generated).toContain('"organizations"."chamber" is null')
    expect(generated).toContain("openstatesParent")
