...
const mocks = vi.hoisted(() => ({
  search: vi.fn<typeof import("../ingestion/regulations/passage-search.js").searchCopiedLegalPassages>()
}))
vi.mock("../ingestion/regulations/passage-search.js", () => ({ searchCopiedLegalPassages: mocks.search }))
