...
/** Call inside both serving transactions. Locks counters and compares complete receipt revision manifests. */
export async function requireLegalCopyReceiptRevisions(
  ...
  // Match String.prototype.trim used by preparation, including non-ASCII whitespace in publisher headings.
  const contextWhitespace =
    "\t\n\v\f\r \u00a0\u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200a\u2028\u2029\u202f\u205f\u3000\ufeff"
  // Aggregate in PostgreSQL so a national query does not transfer hundreds of thousands of revision rows.
